...
{
    private readonly Wish _wish1 = new(new Guid("71C37617-C3B4-4675-A24A-CCDC8B2F5AA6"),"FirstWishName", null);
    private readonly Wish _wish2 = new(new Guid("8DECFC39-E3B2-4791-A6D0-51848AA4C2BB"), "SecondWishName", null);
    private readonly Wish _wish3 = new(new Guid("1A1A6507-3E82-417B-8FDB-C98E72135FDD"), "ThirdWishName", null);
